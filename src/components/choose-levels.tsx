...
import { LEVELS } from "../lib/types.d"

export function ChooseLevels() {
    const isSomeChecked = useRef(false)
    const setQuestionsLevel = useQuestionsStore(state => state.setQuestionsLevel)
    ...
    return (
        <section className="w-full h-full flex justify-center  p-2 items-center ">
            ...
            <form onSubmit={handleSubmit} className="flex -translate-y-6 flex-col p-4 justify-center items-center" >
                ...
                <h3 className="text-xl text-indigo-700 font-semibold text-balance text-center">Selecciona los niveles de dificultad que quieres</h3>
